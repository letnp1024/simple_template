...
export function initCategoryPortfolioSection() {
    const categoryPortfolioSection = document.querySelector('#category-portfolio');
    const categorySidebar = categoryPortfolioSection === null || categoryPortfolioSection === void 0 ? void 0 : categoryPortfolioSection.querySelector('.category-sidebar');
    const categoryBg = categorySidebar === null || categorySidebar === void 0 ? void 0 : categorySidebar.querySelector('.category-sidebar__bg');
    const categoryItems = categoryPortfolioSection === null || categoryPortfolioSection === void 0 ? void 0 : categoryPortfolioSection.querySelectorAll('.category-item');
    const portfolioItems = categoryPortfolioSection === null || categoryPortfolioSection === void 0 ? void 0 : categoryPortfolioSection.querySelectorAll('.portfolio-item');
...
//# sourceMappingURL=category-portfolio.js.map